 ...
 * Use the [BikeItemFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BikeItemFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_bike_item, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment BikeItemFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BikeItemFragment().apply {
